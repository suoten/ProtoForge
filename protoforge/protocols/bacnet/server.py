...
class BACnetServer(ProtocolServer):
    ...
    async def create_device(self, device_config: DeviceConfig) -> str:
        ...
        bacnet_device_id = self._device_id_base + len(self._device_configs)
        objects = []
        ...
        logger.info("BACnet device created: %s (BACnet ID: %d, %d objects)",
                     device_id, bacnet_device_id, len(objects))
        return device_id
