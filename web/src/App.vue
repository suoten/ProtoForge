...
const menuOptions = computed(() => [
  ...
  { label: '审计日志', key: '/audit', icon: svgIcon('M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z') },
  { label: '备份恢复', key: '/backup', icon: svgIcon('M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4 M7 10l5 5 5-5 M12 15V3') },
])
